...
public class GeneticResourceTransferResourceImpl implements GeneticResourceTransferResource {
	 ...
	 */
	@Override
	public void create(String authorization, GeneticResourceTransfer geneticRessourceTransfer,
			AsyncResponse asyncResponse) {
		Response response = null;
		Session session = null;
		try {
			session = ConnectionProvider.getInstance().getSession();
			GeneticResourceTransferService service = new GeneticResourceTransferService(session);
