...
public interface UserRESTResource {
	...
	@Produces({ MediaType.APPLICATION_JSON + DEFAULT_RESPONSE_ENCODING })
	@ManagedAsync
	public void register(final PersonLegalTO person, @HeaderParam(HEADER_LANGUAGE) String language,
			@Suspended final AsyncResponse asyncResponse);
	...
	@Produces({ MediaType.APPLICATION_JSON + DEFAULT_RESPONSE_ENCODING })
	@ManagedAsync
	public void register(final PersonNaturalTO person, @HeaderParam(HEADER_LANGUAGE) String language,
			@Suspended final AsyncResponse asyncResponse);
	...
	@Produces({ MediaType.APPLICATION_JSON + DEFAULT_RESPONSE_ENCODING })
	@ManagedAsync
	public void confirm(final PersonTO person, @QueryParam(QUERY_PARAM_TOKEN) String token,
			@Suspended final AsyncResponse asyncResponse);
