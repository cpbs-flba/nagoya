...
public final class GeneticResourceTransformer {
    ...
    public static com.nagoya.model.dbo.resource.GeneticResourceDBO getDBO(com.nagoya.model.dbo.resource.GeneticResourceDBO dbo,
        com.nagoya.model.to.resource.GeneticResourceTO dto) {
        if (dto == null) {
            return null;
        }
        if (dbo == null) {
    ...
    public static Set<com.nagoya.model.dbo.resource.ResourceFileDBO> getDBO(Set<com.nagoya.model.to.resource.ResourceFileTO> dto) {
        if (dto == null) {
            return null;
        }
    ...
    public static com.nagoya.model.to.resource.GeneticResourceTO getDTO(com.nagoya.model.dbo.resource.GeneticResourceDBO dbo) {
        if (dbo == null) {
            return null;
        }
    ...
    public static Set<com.nagoya.model.to.resource.ResourceFileTO> getDTO(Set<com.nagoya.model.dbo.resource.ResourceFileDBO> dbo) {
        if (dbo == null) {
            return null;
        }
